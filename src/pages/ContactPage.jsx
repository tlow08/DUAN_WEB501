    ...
    <section className="container grid lg:grid-cols-2 md:grid-cols-1 mt-16 gap-8">
        ...
        <div className="p-2">
            <form action="" className="grid grid-cols-1 shadow-xl rounded-xl p-4">
                <h1 className="text-2xl text-center font-bold text-yellow-600 my-3">Enter your request</h1>
                <div className="w-full grid grid-cols-1">
                    <label htmlFor="" className="text-xl font-semibold my-2">Full Name:</label>
                    <input type="text" name="" id="" className="border py-2 pl-3 outline-none"  placeholder="Not be empty..."/>
                </div>
                <div className="w-full grid grid-cols-1">
                    <label htmlFor="" className="text-xl font-semibold my-2">Email:</label>
                    <input type="text" name="" id="" className="border py-2 pl-3 outline-none"  placeholder="Not be empty..."/>
                </div>
                <div className="w-full grid grid-cols-1">
                    <label htmlFor="" className="text-xl font-semibold my-2">Address:</label>
                    <input type="text" name="" id="" className="border py-2 pl-3 outline-none"  placeholder="Not be empty..."/>
                </div>
                <div className="w-full grid grid-cols-1">
                    <label htmlFor="" className="text-xl font-semibold my-2">Content:</label>
                    <textarea name="" id="" className="border py-2 pl-3 outline-none" placeholder="Not be empty..."></textarea>
                </div>
                <div className="my-4 text-white text-xl font-semibold">
                    <button type="submit" className="w-full py-3 bg-yellow-600 hover:bg-yellow-700">Send now</button>
                </div>
            </form>
        </div>
    </section>
